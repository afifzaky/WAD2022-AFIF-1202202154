...
$id = $_GET['id'];
$sql = "SELECT * FROM showroom_afif_table WHERE id_mobil = $id";
...
<head>
  ...
  <title>Detail Car | Afif_1202202154</title>
        ...
        echo "
                ...
                <div class='d-flex justify-content-center align-items-start gap-5 mt-5'>
                  ...
                  <form action='' enctype='multipart/form-data'>
                    ...
                    <a href='Editfile-Afif.php?id=" . $getDetail["id_mobil"] . "' class='btn btn-success' style='margin-top: 40px;'>Edit</a>
                  </form>
                </div>
            ";
      }
